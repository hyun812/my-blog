...
const HeaderNavigation = () => {
  ...
  return (
    <>
      <nav className="sticky top-0 h-16 border-b font-bold z-50">
        <div className="max-w-4xl lg:max-w-2xl mx-auto px-8 lg:px-0 h-full flex items-center justify-between glassmorphism">
